        ...
        <table style={{ width: "100%", borderCollapse: "collapse", textAlign: "left" }}>
          <thead>
            <tr style={{ backgroundColor: "#007bff", color: "white" }}>
              ...
              <th style={{ padding: "10px", border: "1px solid #ddd" }}>Aadhar</th>
            </tr>
          </thead>
          <tbody>
            {patients.map((patient) => (
              <tr key={patient.patient_id}>
                <td style={{ padding: "10px", border: "1px solid #ddd" }}>{patient.full_name}</td>
                <td style={{ padding: "10px", border: "1px solid #ddd" }}>{patient.contact_number}</td>
                ...
                <td style={{ padding: "10px", border: "1px solid #ddd" }}>{patient.pincode}</td>
                <td style={{ padding: "10px", border: "1px solid #ddd" }}>{patient.gender}</td>
                <td style={{ padding: "10px", border: "1px solid #ddd" }}>{patient.aadhar}</td>
              </tr>
            ))}
          </tbody>
        </table>
